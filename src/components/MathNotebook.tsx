        ...
        <div className='notebook-card-body'>
          ...
          {entry.questionText && (
            <div className='notebook-question'>
              ...
              <span className='notebook-question-text'>
                {entry.questionText}
              </span>
            </div>
          )}
            ...
            {editingNote ? (
              ...
              <div className='notebook-note-display'>
                {entry.note ? (
                  ...
                  <p className='notebook-note-placeholder'>
                    Brak notatki. Kliknij "Edytuj" żeby dodać swoje
                    spostrzeżenia.
                  </p>
                )}
              </div>
          ...
          <div className='notebook-card-actions'>
            ...
            {!confirmDelete ? (
              ...
              <div className='notebook-delete-confirm'>
                ...
                <button
                  className='notebook-confirm-yes'
                  onClick={() => onDelete(entry.id)}
                >
                  Tak
                </button>
                <button
                  className='notebook-confirm-no'
...
const MathNotebook: React.FC<MathNotebookProps> = ({
  onSolveInChat,
  onNavigateToChat,
  onEntryDeleted,
}) => {
      ...
      <div className='notebook-container'>
        <div className='notebook-header'>
          ...
          <p className='notebook-subtitle'>
            Tutaj znajdziesz zapisane rozwiązania
          </p>
        </div>
        <div className='notebook-empty'>
          ...
          <p>
            Podczas rozmowy z Formulo kliknij przycisk{' '}
            <strong>🔖 Zapisz</strong> przy odpowiedzi agenta, żeby dodać
            rozwiązanie do notatnika. Idealne do powtórek przed maturą!
          </p>
    ...
    <div className='notebook-wrapper'>
      <div className='notebook-container'>
        ...
        <div className='notebook-header'>
          ...
          <p className='notebook-subtitle'>
            Twoje zapisane rozwiązania – zawsze pod ręką
          </p>
        </div>
        ...
        <div className='notebook-footer'>
          <p>
            💡 Wskazówka: Kliknij na kartę żeby rozwinąć pełne rozwiązanie i
            dodać własne notatki.
          </p>
        </div>
      </div>
    </div>
