...
const StudyPlan: React.FC<StudyPlanProps> = ({
  ...
  const handleSubmitTask = (taskNumber: number) => {
    ...
    const topics =
      plan.level === 'podstawowa' ? TOPICS_PODSTAWOWA : TOPICS_ROZSZERZONA;
      ...
      <div className='setup-card'>
        ...
        <div className='setup-section'>
          <label className='setup-label'>
            Dzienna norma nauki:{' '}
            <span className='goal-value'>{dailyGoal} min</span>
          </label>
          <input
            type='range'
            min='15'
                  ...
                  <div className='topic-progress'>
                    ...
                    <div className='progress-bar'>
                      <div
                        ...
                        style={{
                          width: `${(progress.tasksCompleted / progress.tasksTotal) * 100}%`,
                        }}
                      ></div>
                    </div>
                  </div>
          ...
          {!showDeleteConfirm ? (
            ...
            <div className='delete-confirm'>
              ...
              <div className='confirm-buttons'>
                <button className='confirm-yes' onClick={onDeletePlan}>
                  Tak, usuń
                </button>
                <button
      ...
      <div className='topic-detail-card'>
        ...
        <div className='topic-progress-section'>
          <h2 className='progress-label'>
            Postęp: {progress.tasksCompleted}/{progress.tasksTotal}
          </h2>
          ...
          {progress.quizScore === null ? (
            ...
            <div className='quiz-result'>
              <p className='quiz-score-text'>
                Twój wynik: <strong>{progress.quizScore}%</strong>
              </p>
              <button className='quiz-button' onClick={onCompleteQuiz}>
                Powtórz quiz
              </button>
